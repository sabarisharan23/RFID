import { AppRoute, AppRouteMutation, AppRouteQuery, AppRouter, FlattenAppRouter, ServerInferRequest, ServerInferResponseBody, ServerInferResponses } from '@ts-rest/core';
import { Express, NextFunction, Response, Request } from 'express-serve-static-core';
import { RequestValidationError } from './request-validation-error';
export type AppRouteQueryImplementation<T extends AppRouteQuery> = (input: ServerInferRequest<T, Express['request']['headers']> & {
    req: TsRestRequest<T>;
    res: Response;
}) => Promise<ServerInferResponses<T>>;
export type AppRouteMutationImplementation<T extends AppRouteMutation> = (input: ServerInferRequest<T, Express['request']['headers']> & {
    files: unknown;
    file: unknown;
    req: TsRestRequest<T>;
    res: Response;
