  ...
  const debouncedSearch = useCallback(
    _.debounce((rfidInput: string) => {
      if (!rfidInput.trim()) {
        ...
        setFields(assetType.find((at) => at.id === selectedAssetTypeId)?.fields || {});
        setSelectedCupboardId('');
        setSelectedRackId('');
        setSelectedRowId('');
        return;
      ...
      if (foundAsset) {
        ...
        while (currentAsset.parentId) {
          const parentAsset = assets.find((asset) => asset.RFID === currentAsset.parentId);
      ...
      <div className="bg-white mt-6 shadow rounded p-6">
        ...
        <div className="mt-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <button onClick={handleScan} className="bg-red-500 text-white px-4 py-2 rounded">
              Scan
            </button>
          </div>
